export default {
  ...
  publicRuntimeConfig: {
    ...
    newDevices:(process.env.API_HOST || '')+'/console/1.0/adv/tenant-dev-creation',
    remDevices:(process.env.API_HOST || '')+'/console/1.0/adv/tenant-dev-deletion',
    consDevices:(process.env.API_HOST || '')+'/console/1.0/adv/top-dev-consuming',
    captchaGetChallenge:(process.env.API_HOST || '')+'/console/1.0/captcha/generate',
    captchaGetPad:(process.env.API_HOST || '')+'/console/1.0/captcha',
    captchaGetValidation:(process.env.API_HOST || '')+'/console/1.0/captcha/pad',
    ...
    disableCaptcha:process.env.DIS_CAPTCHA || 'false',
