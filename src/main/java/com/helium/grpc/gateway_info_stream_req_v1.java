...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return IotConfig.internal_static_helium_iot_config_gateway_info_stream_req_v1_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return IotConfig.internal_static_helium_iot_config_gateway_info_stream_req_v1_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            gateway_info_stream_req_v1.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof gateway_info_stream_req_v1)) {
      return super.equals(obj);
    }
    gateway_info_stream_req_v1 other = (gateway_info_stream_req_v1) obj;
  ...
  public static gateway_info_stream_req_v1 parseFrom(
  ...
  public static gateway_info_stream_req_v1 parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static gateway_info_stream_req_v1 parseFrom(
  ...
  public static gateway_info_stream_req_v1 parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static gateway_info_stream_req_v1 parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static gateway_info_stream_req_v1 parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(gateway_info_stream_req_v1 prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public gateway_info_stream_req_v1 getDefaultInstanceForType() {
      return gateway_info_stream_req_v1.getDefaultInstance();
    }

    @Override
    public gateway_info_stream_req_v1 build() {
      gateway_info_stream_req_v1 result = buildPartial();
    ...
    @Override
    public gateway_info_stream_req_v1 buildPartial() {
      gateway_info_stream_req_v1 result = new gateway_info_stream_req_v1(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(gateway_info_stream_req_v1 result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof gateway_info_stream_req_v1) {
        return mergeFrom((gateway_info_stream_req_v1)other);
      } else {
    ...
    public Builder mergeFrom(gateway_info_stream_req_v1 other) {
      if (other == gateway_info_stream_req_v1.getDefaultInstance()) return this;
  ...
  private static final gateway_info_stream_req_v1 DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new gateway_info_stream_req_v1();
  }

  public static gateway_info_stream_req_v1 getDefaultInstance() {
