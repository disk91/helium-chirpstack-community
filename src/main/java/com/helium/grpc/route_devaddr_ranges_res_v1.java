...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return IotConfig.internal_static_helium_iot_config_route_devaddr_ranges_res_v1_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return IotConfig.internal_static_helium_iot_config_route_devaddr_ranges_res_v1_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            route_devaddr_ranges_res_v1.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof route_devaddr_ranges_res_v1)) {
      return super.equals(obj);
    }
    route_devaddr_ranges_res_v1 other = (route_devaddr_ranges_res_v1) obj;
  ...
  public static route_devaddr_ranges_res_v1 parseFrom(
  ...
  public static route_devaddr_ranges_res_v1 parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static route_devaddr_ranges_res_v1 parseFrom(
  ...
  public static route_devaddr_ranges_res_v1 parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static route_devaddr_ranges_res_v1 parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static route_devaddr_ranges_res_v1 parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(route_devaddr_ranges_res_v1 prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public route_devaddr_ranges_res_v1 getDefaultInstanceForType() {
      return route_devaddr_ranges_res_v1.getDefaultInstance();
    }

    @Override
    public route_devaddr_ranges_res_v1 build() {
      route_devaddr_ranges_res_v1 result = buildPartial();
    ...
    @Override
    public route_devaddr_ranges_res_v1 buildPartial() {
      route_devaddr_ranges_res_v1 result = new route_devaddr_ranges_res_v1(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(route_devaddr_ranges_res_v1 result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof route_devaddr_ranges_res_v1) {
        return mergeFrom((route_devaddr_ranges_res_v1)other);
      } else {
    ...
    public Builder mergeFrom(route_devaddr_ranges_res_v1 other) {
      if (other == route_devaddr_ranges_res_v1.getDefaultInstance()) return this;
  ...
  private static final route_devaddr_ranges_res_v1 DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new route_devaddr_ranges_res_v1();
  }

  public static route_devaddr_ranges_res_v1 getDefaultInstance() {
