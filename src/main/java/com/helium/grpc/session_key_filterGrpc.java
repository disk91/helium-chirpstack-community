...
public final class session_key_filterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<session_key_filter_list_req_v1,
      session_key_filter_v1> getListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "list",
      requestType = session_key_filter_list_req_v1.class,
      responseType = session_key_filter_v1.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<session_key_filter_list_req_v1,
      session_key_filter_v1> getListMethod() {
    io.grpc.MethodDescriptor<session_key_filter_list_req_v1, session_key_filter_v1> getListMethod;
      ...
      synchronized (session_key_filterGrpc.class) {
        if ((getListMethod = session_key_filterGrpc.getListMethod) == null) {
          session_key_filterGrpc.getListMethod = getListMethod =
              io.grpc.MethodDescriptor.<session_key_filter_list_req_v1, session_key_filter_v1>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "list"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  session_key_filter_list_req_v1.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  session_key_filter_v1.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<session_key_filter_get_req_v1,
      session_key_filter_v1> getGetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "get",
      requestType = session_key_filter_get_req_v1.class,
      responseType = session_key_filter_v1.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<session_key_filter_get_req_v1,
      session_key_filter_v1> getGetMethod() {
    io.grpc.MethodDescriptor<session_key_filter_get_req_v1, session_key_filter_v1> getGetMethod;
    if ((getGetMethod = session_key_filterGrpc.getGetMethod) == null) {
      synchronized (session_key_filterGrpc.class) {
        if ((getGetMethod = session_key_filterGrpc.getGetMethod) == null) {
          session_key_filterGrpc.getGetMethod = getGetMethod =
              io.grpc.MethodDescriptor.<session_key_filter_get_req_v1, session_key_filter_v1>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "get"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  session_key_filter_get_req_v1.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  session_key_filter_v1.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<session_key_filter_update_req_v1,
      session_key_filter_update_res_v1> getUpdateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "update",
      requestType = session_key_filter_update_req_v1.class,
      responseType = session_key_filter_update_res_v1.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<session_key_filter_update_req_v1,
      session_key_filter_update_res_v1> getUpdateMethod() {
    io.grpc.MethodDescriptor<session_key_filter_update_req_v1, session_key_filter_update_res_v1> getUpdateMethod;
    if ((getUpdateMethod = session_key_filterGrpc.getUpdateMethod) == null) {
      synchronized (session_key_filterGrpc.class) {
        if ((getUpdateMethod = session_key_filterGrpc.getUpdateMethod) == null) {
          session_key_filterGrpc.getUpdateMethod = getUpdateMethod =
              io.grpc.MethodDescriptor.<session_key_filter_update_req_v1, session_key_filter_update_res_v1>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "update"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  session_key_filter_update_req_v1.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  session_key_filter_update_res_v1.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<session_key_filter_stream_req_v1,
      session_key_filter_stream_res_v1> getStreamMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "stream",
      requestType = session_key_filter_stream_req_v1.class,
      responseType = session_key_filter_stream_res_v1.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<session_key_filter_stream_req_v1,
      session_key_filter_stream_res_v1> getStreamMethod() {
    io.grpc.MethodDescriptor<session_key_filter_stream_req_v1, session_key_filter_stream_res_v1> getStreamMethod;
    if ((getStreamMethod = session_key_filterGrpc.getStreamMethod) == null) {
      synchronized (session_key_filterGrpc.class) {
        if ((getStreamMethod = session_key_filterGrpc.getStreamMethod) == null) {
          session_key_filterGrpc.getStreamMethod = getStreamMethod =
              io.grpc.MethodDescriptor.<session_key_filter_stream_req_v1, session_key_filter_stream_res_v1>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "stream"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  session_key_filter_stream_req_v1.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  session_key_filter_stream_res_v1.getDefaultInstance()))
  ...
  public static abstract class session_key_filterImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void list(session_key_filter_list_req_v1 request,
                     io.grpc.stub.StreamObserver<session_key_filter_v1> responseObserver) {
     ...
     * </pre>
     */
    public void get(session_key_filter_get_req_v1 request,
                    io.grpc.stub.StreamObserver<session_key_filter_v1> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<session_key_filter_update_req_v1> update(
        io.grpc.stub.StreamObserver<session_key_filter_update_res_v1> responseObserver) {
     ...
     * </pre>
     */
    public void stream(session_key_filter_stream_req_v1 request,
                       io.grpc.stub.StreamObserver<session_key_filter_stream_res_v1> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                session_key_filter_list_req_v1,
                session_key_filter_v1>(
                  this, METHODID_LIST)))
          .addMethod(
            getGetMethod(),
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                session_key_filter_get_req_v1,
                session_key_filter_v1>(
                  this, METHODID_GET)))
          .addMethod(
            getUpdateMethod(),
            io.grpc.stub.ServerCalls.asyncClientStreamingCall(
              new MethodHandlers<
                session_key_filter_update_req_v1,
                session_key_filter_update_res_v1>(
                  this, METHODID_UPDATE)))
          .addMethod(
            getStreamMethod(),
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                session_key_filter_stream_req_v1,
                session_key_filter_stream_res_v1>(
  ...
  public static final class session_key_filterBlockingStub extends io.grpc.stub.AbstractBlockingStub<session_key_filterBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<session_key_filter_v1> list(
        session_key_filter_list_req_v1 request) {
     ...
     * </pre>
     */
    public java.util.Iterator<session_key_filter_v1> get(
        session_key_filter_get_req_v1 request) {
      return io.grpc.stub.ClientCalls.blockingServerStreamingCall(
     ...
     * </pre>
     */
    public java.util.Iterator<session_key_filter_stream_res_v1> stream(
        session_key_filter_stream_req_v1 request) {
      return io.grpc.stub.ClientCalls.blockingServerStreamingCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST:
          serviceImpl.list((session_key_filter_list_req_v1) request,
              (io.grpc.stub.StreamObserver<session_key_filter_v1>) responseObserver);
          break;
        case METHODID_GET:
          serviceImpl.get((session_key_filter_get_req_v1) request,
              (io.grpc.stub.StreamObserver<session_key_filter_v1>) responseObserver);
          break;
        case METHODID_STREAM:
          serviceImpl.stream((session_key_filter_stream_req_v1) request,
              (io.grpc.stub.StreamObserver<session_key_filter_stream_res_v1>) responseObserver);
          break;
        default:
