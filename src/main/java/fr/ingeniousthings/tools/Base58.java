...
public class Base58 {
     ...
     * @throws ITParseException if the input is not base 58 or the checksum does not validate.
     *//*
    public static byte[] decodeChecked(String input) throws ITParseException {
