...
public interface GetRegionResponseOrBuilder extends
   ...
   */
  java.util.List<io.chirpstack.api.RegionChannel> 
   ...
   * <code>repeated .api.RegionChannel uplink_channels = 4;</code>
   */
  io.chirpstack.api.RegionChannel getUplinkChannels(int index);
  /**
   * <pre>
   * Uplink channels.
   * </pre>
   ...
   * <code>repeated .api.RegionChannel uplink_channels = 4;</code>
   */
  java.util.List<? extends io.chirpstack.api.RegionChannelOrBuilder> 
   ...
   * <code>repeated .api.RegionChannel uplink_channels = 4;</code>
   */
  io.chirpstack.api.RegionChannelOrBuilder getUplinkChannelsOrBuilder(
      int index);
