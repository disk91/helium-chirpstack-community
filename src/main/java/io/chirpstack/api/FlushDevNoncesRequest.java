...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return DeviceProto.internal_static_api_FlushDevNoncesRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return DeviceProto.internal_static_api_FlushDevNoncesRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            FlushDevNoncesRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof FlushDevNoncesRequest)) {
      return super.equals(obj);
    }
    FlushDevNoncesRequest other = (FlushDevNoncesRequest) obj;
  ...
  public static FlushDevNoncesRequest parseFrom(
  ...
  public static FlushDevNoncesRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static FlushDevNoncesRequest parseFrom(
  ...
  public static FlushDevNoncesRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static FlushDevNoncesRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static FlushDevNoncesRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(FlushDevNoncesRequest prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public FlushDevNoncesRequest getDefaultInstanceForType() {
      return FlushDevNoncesRequest.getDefaultInstance();
    }

    @Override
    public FlushDevNoncesRequest build() {
      FlushDevNoncesRequest result = buildPartial();
    ...
    @Override
    public FlushDevNoncesRequest buildPartial() {
      FlushDevNoncesRequest result = new FlushDevNoncesRequest(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(FlushDevNoncesRequest result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof FlushDevNoncesRequest) {
        return mergeFrom((FlushDevNoncesRequest)other);
      } else {
    ...
    public Builder mergeFrom(FlushDevNoncesRequest other) {
      if (other == FlushDevNoncesRequest.getDefaultInstance()) return this;
  ...
  private static final FlushDevNoncesRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new FlushDevNoncesRequest();
  }

  public static FlushDevNoncesRequest getDefaultInstance() {
